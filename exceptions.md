...
```python
>>>Print('Привет, Мир!')
Traceback(most recent calllast): File"<pyshell#0>", line1, in <module> Print('Привет, Мир!')
...
Введитечто-нибудь-->        # Нажмите ctrl-d
...
class ShortInputException(Exception):
  ...
  def __init__(self, length, atleast):
    ...
    self.length=length.self.atleast = atleast
...
```
$ python3 finally.py
Программироватьвесело Если работа скучна, Чтобы придать ей весёлый тон-
